...
const STUDENTS = [
  { id: 'HV001', name: 'Nguyễn Văn Nam', class: 'DE-A1-K24', attendance: 95, midTerm: 8.5, status: 'Active', avatar: 'N' },
  { id: 'HV002', name: 'Trần Thị Bích', class: 'DE-A1-K24', attendance: 80, midTerm: 7.0, status: 'Active', avatar: 'T' },
  { id: 'HV003', name: 'Lê Văn Cường', class: 'DE-A1-K24', attendance: 65, midTerm: 4.5, status: 'Risk', avatar: 'L' }, 
  { id: 'HV004', name: 'Phạm Hương', class: 'DE-A2-K10', attendance: 100, midTerm: 9.0, status: 'Active', avatar: 'P' },
  { id: 'HV005', name: 'Hoàng Văn Em', class: 'DE-A2-K10', attendance: 40, midTerm: null, status: 'Dropout', avatar: 'H' },
];
