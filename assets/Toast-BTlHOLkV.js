import{R as o,j as e}from"./index-CT86JjTq.js";import{C as t}from"./circle-x-CxCeVkNt.js";import{I as l}from"./info-BJxEbyIj.js";import{C as c}from"./circle-alert-C1QYOdzY.js";import{C as x}from"./circle-check-CH_QgZJL.js";const p=({message:a,type:r,onClose:s})=>{o.useEffect(()=>{const m=setTimeout(()=>{s()},3e3);return()=>clearTimeout(m)},[s]);const i={success:"bg-green-50 border-green-500 text-green-900",error:"bg-red-50 border-red-500 text-red-900",warning:"bg-amber-50 border-amber-500 text-amber-900",info:"bg-blue-50 border-blue-500 text-blue-900"},n={success:e.jsx(x,{size:20,className:"text-green-600"}),error:e.jsx(t,{size:20,className:"text-red-600"}),warning:e.jsx(c,{size:20,className:"text-amber-600"}),info:e.jsx(l,{size:20,className:"text-blue-600"})};return e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
            @keyframes slideIn {
               from {
