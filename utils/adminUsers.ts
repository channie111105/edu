...
const STORAGE_KEY = 'educrm_admin_users_v2';
...
const INITIAL_ADMIN_USERS: AdminUserRecord[] = [
  ...
  },
  {
    id: 'u5',
    name: 'Vũ Đào Tạo',
    email: 'training@educrm.com',
    username: 'training',
    role: UserRole.TRAINING,
    roles: [UserRole.TRAINING],
  ...
  },
  {
    id: 'u7',
    name: 'Đặng Ghi Danh',
    email: 'enrollment@educrm.com',
    username: 'enrollment',
    role: UserRole.SALES_LEADER,
    roles: [UserRole.SALES_LEADER],
    department: 'Ban Hợp đồng & Ghi danh',
    branch: 'Hà Nội',
    team: 'Team Hợp đồng',
    title: 'Trưởng bộ phận Hợp đồng',
    accountStatus: 'active',
    contractType: 'official',
    employmentStatus: 'working',
    avatar: 'GD',
