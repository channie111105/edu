...
const STORAGE_KEY = 'educrm_admin_users_v1';
...
const INITIAL_ADMIN_USERS: AdminUserRecord[] = [
  {
    ...
    username: 'tran.van.quan.tri',
    role: UserRole.ADMIN,
    roles: [UserRole.ADMIN, UserRole.SALES_LEADER],
  ...
  },
  {
    id: 'u3',
    name: 'David Clark',
    email: 'david.clark@educrm.com',
    username: 'david.clark',
    role: UserRole.SALES_LEADER,
    roles: [UserRole.SALES_LEADER],
    department: 'Kinh doanh (Sales)',
    branch: 'HCM',
    team: 'Team Trung',
    managerId: 'u1',
    title: 'Trưởng nhóm Sales',
    accountStatus: 'active',
    contractType: 'official',
    employmentStatus: 'working',
    lastLoginAt: '2026-04-23T17:45',
  ...
  },
  {
    ...
    contractType: 'official',
    employmentStatus: 'working',
    lastLoginAt: '2026-04-22T21:10',
    startDate: '2021-09-05',
    avatar: 'NL',
    createdAt: '2021-09-05T08:00:00.000Z',
    updatedAt: '2026-04-22T21:10:00.000Z',
  },
  {
    id: 'u6',
    name: 'Trần Văn Minh',
    ...
    contractType: 'official',
    employmentStatus: 'paused',
    lastLoginAt: '2026-04-18T18:25',
    startDate: '2022-05-12',
    avatar: 'TM',
    createdAt: '2022-05-12T08:00:00.000Z',
    updatedAt: '2026-04-18T18:25:00.000Z',
  },
  {
    id: 'u7',
    ...
    roles: [UserRole.STUDY_ABROAD],
    department: 'Du học (Study Abroad)',
    branch: 'Hà Nội',
    team: 'Team Du học',
    managerId: 'u1',
    title: 'Chuyên viên Du học',
    accountStatus: 'active',
    contractType: 'official',
    employmentStatus: 'working',
    lastLoginAt: '2026-04-23T15:05',
    startDate: '2023-06-01',
    avatar: 'NN',
    createdAt: '2023-06-01T08:00:00.000Z',
    updatedAt: '2026-04-23T15:05:00.000Z',
  },
  {
    id: 'u8',
    name: 'Vũ Minh Hiếu',
